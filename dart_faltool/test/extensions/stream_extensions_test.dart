  ...
  group('FalconToolStreamExtension', () {
    ...
    group('toSetStream', () {
      test('should collect unique events into set', () async {
        final stream =
            Stream.fromIterable([1, 2, 2, 3, 3, 4]);
    ...
    group('onErrorReturnWith', () {
      test(
        ...
        () async {
          ...
          final safe =
              stream.onErrorReturnWith((error, stackTrace) {
    ...
    group('doOnData', () {
      test('should execute action for each event', () async {
        ...
        final stream = Stream.fromIterable([1, 2, 3]);
        final logged = stream.doOnData(sideEffects.add);
    ...
    group('doOnError', () {
      test('should execute action on errors', () async {
        ...
        // Use onErrorReturn to handle the error after
        // doOnError logs it
    ...
    group('doOnDone', () {
      test(
        ...
        () async {
          ...
          final stream = Stream.fromIterable([1, 2, 3]);
          final tracked =
              stream.doOnDone(() => completed = true);
  ...
  group('FalconToolNullableStreamExtension', () {
    group('whereNotNull', () {
      test('should filter out null values', () async {
        final stream =
            Stream.fromIterable([1, null, 2, null, 3]);
    ...
    group('mapNotNull', () {
      ...
      test('should handle empty result', () async {
        final stream =
            Stream<int?>.fromIterable([null, null]);
